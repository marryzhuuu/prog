...
- `remove_any_by_cave cave` : удалить из коллекции один элемент, значение поля cave которого эквивалентно заданному
...
public class Coordinates {
    private float x; //Значение поля должно быть больше -506
    private Double y; //Значение поля должно быть больше -948, Поле не может быть null
}
